namespace Builder {
    ...
    //abstract class中的TRocket extends Rocket意味着由实现abstract class的class来决定TRocket
    ...
    class Director {
        //class中的TRocket extends Rocket意味着由argus的<>决定TRocket，或call时决定TRocket
    ...
    // class SoundingRocketBuilder<TRocket extends Rocket, TPayload extends Payload> extends RocketBuilder<TRocket, TPayload> {
    ...
    let dirctor = new Director()
    let soundingRocketBuilder = new SoundingRocketBuilder()
    dirctor.prepareRocket(soundingRocketBuilder,new Probe())
    // FREIGHT ROCKET
    ...
    class FreightRocket implements Rocket {
        payload: Satellite;
        stages = <any>[] as FreightRocketStages;
    }
